...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnPoint,btnEqual,btnClear,btnPOM,btnDelete;        //按钮：小数点，等号，清空,正负号,清行
                ...
                switch(button.getId())//获取点击按钮的ID，通过ID选择对应的选项执行
                {
                    ...
                    case R.id.buttonPoint://小数点.
                    {
                        ...
                        else //如果没有小数点
                        {
                            ...
                            else if(str.equals(""))//如果初时显示为空，就仍旧显示为空
                            {}
                            else
                    ...
                    case R.id.buttonPlusOrMinus: //操作符正负号
                    {
                        str = editText.getText().toString();
                        editText.setText('-'+str);
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPOM.setOnClickListener(lisenter);
